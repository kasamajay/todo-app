...
## Key files
- `api/internal/handlers/attachments_handler.go`
- `api/internal/storage/attachments_store.go` — `BlobPath`, `WriteBlob`, `ReadBlob`, `DeleteBlob`
- `api/internal/models/models.go` — `Attachment`
